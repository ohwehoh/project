    ...
    <main class="contents" class="border">
        ...
        <section id="board-type" class="section center mb100">
            <div class="container">
                ...
                <p class="section__desc">모든 후기를 자유롭게 작성해주세요</p>
                <div class="board_inner">
                    ...
                    <div class="board__table">
                        <table class="hover">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT row_number() OVER (ORDER BY b.boardView DESC) r, b.boardID, b.boardTitle, m.youID, b.regTime, b.boardView, m.memberID, b.boardType FROM TPmyBoardR b JOIN TPmyMember m ON(m.memberID = b.memberID) ORDER BY boardView DESC LIMIT 0, 5";
                        ...
                        <table class="hover">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT b.boardID, b.boardTitle, m.youID, b.regTime, b.boardView, m.memberID, b.boardType FROM TPmyBoardR b JOIN TPmyMember m ON(m.memberID = b.memberID) ORDER BY boardID DESC LIMIT {$pageLimit}, {$pageView}";
